...
async function main() {
	...
	*/
	...
	regl.frame((frame) => {
		...
		*/
		const rotation = mat4.fromZRotation(mat4.create(), sim_time * Math.PI / 6.); 
		const translation = mat4.fromTranslation(mat4.create(), [0.5, 0., 0.]);
		...
		draw_triangle_with_transform({
			mat_transform: rotateThenTranslate,
			color: color_red,
		});
