...
Finally, we used our previous work in the shaders to implement Blinn-Phong lighting. Here, not much was changed. We compute all needed positions in the vertex shader then we do the computations in the fragment shader.
